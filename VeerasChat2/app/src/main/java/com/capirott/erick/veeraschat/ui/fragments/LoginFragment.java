...
import com.capirott.erick.veeraschat.core.login.LoginContract;
import com.capirott.erick.veeraschat.core.login.LoginPresenter;
import com.capirott.erick.veeraschat.core.registration.RegisterInteractor;
import com.capirott.erick.veeraschat.ui.activities.RegisterActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private Button mBtnLoginAnonymously;
    ...
    private void bindViews(View view) {
        ...
        mBtnLoginAnonymously = (Button) view.findViewById(R.id.button_login_anonymously);
    }
    ...
    private void init() {
        ...
        mBtnLoginAnonymously.setOnClickListener(this);
        setDummyCredentials();
    }
    ...
    public void onClick(View view) {
        ...
        switch (viewId) {
            ...
            case R.id.button_register:
                onRegister(view);
                break;
            case R.id.button_login_anonymously:
                onLoginAnonymously();
                break;
        }
    }
    ...
    private void onLoginAnonymously() {
        new SharedPrefUtil(getContext()).saveBoolean(Constants.ARG_ISANON, true);
        RegisterActivity.startActivity(getActivity());
    }

    private void onLogin(View view) {
        new SharedPrefUtil(getContext()).saveBoolean(Constants.ARG_ISANON, false);
